                ...
                <section className="bg-white rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-sm">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-primary-900 mb-8 border-b-2 border-accent/20 pb-4">
                            Arsa Payı Nedir? Kentsel Dönüşümdeki Kritik Önemi
                        </h2>
                        
                        <div className="prose prose-lg prose-slate max-w-none">
                            <p>
                                Gayrimenkul hukukunda <strong>Arsa Payı</strong>, bir binadaki bağımsız bölümlerin (daire, dükkan vb.), ana taşınmazın (arsanın) ortak mülkiyetindeki hak oranını ifade eder. Kentsel dönüşüm sürecinde arsa payı, sadece bir rakam değil; binanız yıkıldıktan sonra arsada sahip olduğunuz metrekarenin yasal karşılığıdır.
                            </p>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Arsa Payı Nasıl Belirlenir?</h3>
                            <p>
                                Kat Mülkiyeti Kanunu'na göre arsa payı, bağımsız bölümlerin inşa edildiği tarihteki <strong>değeriyle oranlı</strong> olarak belirlenmelidir. Ancak eski binalarda genellikle arsa payları gelişi güzel (örneğin her daireye eşit) dağıtılmıştır. Bu durum, kentsel dönüşümde şerefiye farkı yüksek olan daireler arasında haksızlığa yol açabilir.
                            </p>
                            <p className="bg-slate-50 p-6 rounded-2xl border-l-4 border-accent">
                                <strong>Bilgi Notu:</strong> Kat mülkiyeti kurulurken bağımsız bölümlere tahsis edilen arsa payı, sonradan o bölümün değerinin artması veya azalmasıyla değişmez. Ancak yasal bir yanlışlık varsa "Arsa Payı Düzeltme Davası" açılabilir.
                            </p>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">6306 Sayılı Kanun ve Karar Alma Mekanizması</h3>
                            <p>
                                Kentsel dönüşümde en çok sorulan "Binada kimin sözü geçer?" sorusunun cevabı arsa payında gizlidir. Yeni düzenlemelerle birlikte, binanın geleceğine karar vermek için <strong>Salt Çoğunluk</strong> (Pay oranına göre %50+1) yeterlidir. 
                            </p>
                            <ul>
                                <li><strong>Karar Alma:</strong> Arsa payı toplamının yarısından bir fazlasına sahip olan malikler, binanın müteahhide verilmesi veya yeniden yapılması konusunda karar alabilirler.</li>
                                <li><strong>Pay Satışı:</strong> Karara katılmayan maliklerin arsa payları, Bakanlık tarafından rayiç değer üzerinden diğer paydaşlara açık artırma ile satılır. Bu nedenle arsa payınızın doğruluğu, mülkiyet hakkınızın korunması demektir.</li>
                            </ul>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Yanlış Arsa Payı ve Düzeltme Davaları</h3>
                            <p>
                                Eğer binanızda bir daire diğerinden çok daha büyük olduğu halde arsa payları eşitse veya tersi bir durum söz konusuysa, bu durum <strong>Arsa Payı Düzeltme Davası</strong> konusudur. Kentsel dönüşüm süreci başlamadan veya riskli yapı şerhi düşülmeden önce bu davanın açılması, hak sahiplerinin yeni projede daha adil pay almasını sağlar.
                            </p>
                            <div className="grid md:grid-cols-2 gap-6 my-10">
                                <div className="bg-primary-50 p-6 rounded-2xl">
                                    <h4 className="font-bold text-primary-900 mb-2">Haksız Paylaşım Riski</h4>
                                    <p className="text-sm text-primary-800 leading-relaxed">Arsa payı düşük olan malik, yeni yapılacak binada (paylaşım arsa payı üzerinden yapılıyorsa) daha küçük bir daire alma riskiyle karşı karşıya kalabilir.</p>
                                </div>
                                <div className="bg-primary-50 p-6 rounded-2xl">
                                    <h4 className="font-bold text-primary-900 mb-2">Hukuki Güvence</h4>
                                    <p className="text-sm text-primary-800 leading-relaxed">KD Ankara olarak, arsa payı dağılımındaki teknik hataları tespit ediyor ve hukuk departmanımızla mülkiyet haklarınızın korunmasını sağlıyoruz.</p>
                                </div>
                            </div>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Arsa Payı Hesaplama Örneği</h3>
                            <p>
                                Örneğin 1.000 m² bir arsa üzerinde, 10.000/24.000 paydaş ölçeğinde bir payınız varsa, binanız yıkıldığında arsanın 416 m²'si sizin tasarrufunuzdadır. Müteahhit paylaşımı bu metrekare üzerinden yapılacağı için payınızdaki 1 birimlik hata bile büyük maddi kayıplara yol açabilir.
                            </p>

                            <div className="bg-primary-950 text-white p-10 rounded-[3rem] my-12 text-center">
                                <h4 className="text-xl font-bold text-accent mb-4 italic italic">Arsa Payınızın Doğruluğundan Emin Misiniz?</h4>
                                <p className="text-primary-100 mb-8 max-w-2xl mx-auto">
                                    Tapu kaydınızdaki oranlar, binanızın gerçek değerini yansıtmıyor olabilir. Teknik ve hukuki inceleme için uzmanlarımızla iletişime geçin.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button 
                                        onClick={() => navigate.push('/on-analiz')}
                                        className="bg-accent hover:bg-accent-600 text-white px-10 h-14 rounded-2xl font-bold transition-all"
                                    >
                                        Ücretsiz İnceleme Başlat
                                    </Button>
                                    <Button 
                                        variant="outline"
                                        onClick={() => window.location.href = 'tel:+905000000000'}
                                        className="border-white text-white hover:bg-white/10 px-10 h-14 rounded-2xl font-bold transition-all"
                                    >
                                        Uzmanla Görüşün
                                    </Button>
                                </div>
