    ...
    return (
        <CalculatorLayout>
                        ...
                        {results ? (
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 pt-4">
                                    ...
                                    <Button
                                        onClick={() => navigate.push('/tools/paylasim')}
                                        variant="outline"
                                        className="w-full h-12"
                                        size="lg"
                                    >
            ...
            <div className="mt-20 space-y-16">
                ...
                <section className="bg-white rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-sm">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-primary-900 mb-8 border-b-2 border-accent/20 pb-4">
                            İnşaat Alanından Kaç Daire Çıkar? Daire Mixi Rehberi
                        </h2>
                        
                        <div className="prose prose-lg prose-slate max-w-none">
                            <p>
                                Kentsel dönüşüm projelerinde mülk sahiplerinin en çok merak ettiği sorulardan biri, "Binamız yıkılınca bize kaç metrekare ev düşecek?" ve "Binada toplam kaç daire olacak?" sorularıdır. Bu hesaplama, sadece matematiksel bir bölme işlemi değil; imar yönetmelikleri, ortak alan oranları ve pazar talepleriyle şekillenen stratejik bir süreçtir.
                            </p>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Daire Mixi (Karması) Nedir ve Neden Önemlidir?</h3>
                            <p>
                                <strong>Daire Mixi</strong>, bir projede yer alan farklı tipteki (1+1, 2+1, 3+1, 4+1) dairelerin birbirine oranını ifade eder. Ankara'nın farklı bölgelerinde bu karma stratejisi değişkenlik gösterir:
                            </p>
                            <ul>
                                <li><strong>Çankaya (Öveçler, Dikmen):</strong> Genellikle aile yaşamına uygun 3+1 ve 4+1 daireler tercih edilir.</li>
                                <li><strong>Yenimahalle (Batıkent):</strong> Bölgenin demografik yapısına göre 2+1 ve 3+1 karması ön plandadır.</li>
                                <li><strong>Çayyolu / Ümitköy:</strong> Geniş metrekareli lüks konut talebi nedeniyle 4+1 ve üzeri daireler revaçtadır.</li>
                            </ul>
                            <p>
                                Doğru daire mixi, projenin satış hızını ve mülk sahiplerinin alacağı dairenin şerefiye değerini doğrudan etkiler. KD Ankara olarak biz, bölge analizi yaparak en karlı karmayı belirlemenize yardımcı oluyoruz.
                            </p>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Ortak Alan Oranı ve Net/Brüt Farkı</h3>
                            <p>
                                Hesaplama aracımızda göreceğiniz <strong>Ortak Alan Oranı</strong>, binanın toplam inşaat alanından asansörler, yangın merdivenleri, koridorlar ve sığınak gibi ortak kullanım alanlarının çıkarılmasını ifade eder. 
                            </p>
                            <p className="bg-slate-50 p-6 rounded-2xl border-l-4 border-accent">
                                <strong>Bilgi Notu:</strong> Modern binalarda ortak alan payı genellikle %20 ile %30 arasında değişir. Bu pay ne kadar yüksekse, binadaki sosyal donatı (lobi, geniş koridorlar vb.) o kadar fazladır ancak bu durum dairelerin net süpürülebilir alanının küçülmesine neden olabilir.
                            </p>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Ankara İmar Yönetmeliği'ne Göre Daire Büyüklükleri</h3>
                            <p>
                                Ankara'da bir dairenin yasal olarak sahip olması gereken minimum metrekareler yönetmelikle belirlenmiştir. Örneğin, bir dairenin "oturma odası", "yatak odası", "mutfak" ve "banyo" gibi zorunlu bölümlerinin her birinin minimum bir büyüklüğü vardır. Bu standartlara uymayan projeler belediyeden onay alamaz.
                            </p>
                            <div className="grid md:grid-cols-2 gap-6 my-10">
                                <div className="bg-primary-50 p-6 rounded-2xl">
                                    <h4 className="font-bold text-primary-900 mb-2">Satılabilir Brüt Alan</h4>
                                    <p className="text-sm text-primary-800 leading-relaxed">Dairenin duvarları dahil, balkon payları ve kat holündeki payının eklenmiş halidir. Müteahhitler genellikle satışları bu rakam üzerinden yapar.</p>
                                </div>
                                <div className="bg-primary-50 p-6 rounded-2xl">
                                    <h4 className="font-bold text-primary-900 mb-2">Net Süpürülebilir Alan</h4>
                                    <p className="text-sm text-primary-800 leading-relaxed">Dairenin içindeki duvarların arasında kalan, fiilen halı serebileceğiniz alandır. Kullanım konforunu bu rakam belirler.</p>
                                </div>
                            </div>

                            <h3 className="text-2xl font-bold text-primary-800 mt-10 mb-4">Daire Sayısını Artırmanın Yolları</h3>
                            <p>
                                Mevcut inşaat hakkınızla daha fazla daire çıkarmanın yolu, daire metrekarelerini küçültmek veya emsal harici alanları (balkonlar, depolar vb.) yönetmeliğe uygun şekilde optimize etmektir. Ancak burada "Yaşam Kalitesi - Karlılık" dengesi iyi kurulmalıdır. Küçük ve çok sayıda daire mi, yoksa geniş ve az sayıda daire mi bölgenizde daha değerli? Bu sorunun cevabı KD Ankara'nın uzmanlık alanıdır.
                            </p>

                            <div className="bg-accent/10 p-10 rounded-[3rem] my-12 border border-accent/20">
                                <h4 className="text-xl font-bold text-primary-950 mb-4">Sıkça Sorulan Sorular</h4>
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="font-bold text-primary-900">Balkonlar inşaat alanına dahil midir?</h4>
                                        <p className="text-sm text-gray-700 leading-relaxed">Ankara imar yönetmeliğine göre balkonların belirli bir yüzdesi emsal dışı bırakılabilir. Bu, dairenin kullanım alanını artırırken inşaat hakkından yememenizi sağlar.</p>
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-primary-900">Müteahhit daha fazla daire çıkarabilir mi?</h4>
                                        <p className="text-sm text-gray-700 leading-relaxed">Müteahhitler projeyi optimize ederek (emsal harici alanları kullanarak) toplam alanı artırabilir. Ancak bu artışın mülk sahiplerine adil yansıması için sözleşmede "Paylaşım Oranı" netleştirilmelidir.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="bg-primary-950 text-white rounded-[3rem] p-12 text-center relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-3xl font-bold mb-6 italic">Size En Uygun Projeyi Tasarlayalım</h2>
                        <p className="text-primary-200 mb-10 max-w-2xl mx-auto text-lg">
                            Daire sayısı sadece bir rakam değildir. Sizin için en huzurlu ve en karlı yerleşim planını uzman mimarlarımızla birlikte çizelim.
                        </p>
                        <Button 
                            onClick={() => navigate.push('/on-analiz')}
                            className="bg-accent hover:bg-accent-600 text-white px-12 h-14 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-accent/20"
                        >
                            Ön Analiz Başlat
                        </Button>
                    </div>
