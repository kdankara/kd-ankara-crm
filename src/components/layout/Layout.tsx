        ...
        <div className="min-h-screen flex flex-col font-sans text-gray-900">
            ...
            <footer className="bg-primary-950 text-white pt-16 pb-8 border-t border-primary-900">
                <div className="container mx-auto px-4">
                    ...
                    <div className="border-t border-white/10 pt-8 flex flex-col items-center justify-center gap-4 text-xs text-gray-400 text-center">
                        <p>&copy; {new Date().getFullYear()} KD Ankara. Tüm hakları saklıdır.</p>
                        <p className="max-w-2xl text-white/50">Bu site, bilgilendirme amaçlıdır. Verilen oranlar ve hesaplamalar ön bilgi niteliğinde olup resmi bir taahhüt teşkil etmez.</p>
                    </div>
                </div>
            </footer>
