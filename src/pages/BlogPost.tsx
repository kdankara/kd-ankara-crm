...
import { blogPosts } from './Blog'; // Import static data for now
    ...
    if (!post) {
        return (
            <div className="container mx-auto px-4 py-32 text-center min-h-[50vh]">
                ...
                <Link to="/blog" className="text-accent hover:underline">Blog sayfasına dön</Link>
            </div>
        );
    }
        ...
        <article className="pb-24 bg-gray-50/50 min-h-screen">
            ...
            <header className="relative pt-32 pb-24 text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 max-w-3xl">
                    <Link to="/blog" className="inline-flex items-center text-white/70 hover:text-white mb-8 transition-colors text-sm font-medium">
            ...
            <div className="container mx-auto px-4 -mt-10 relative z-20">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 max-w-3xl mx-auto prose prose-lg prose-blue">
                    ...
                    <div className="mt-12 p-6 bg-primary-50 rounded-xl border border-primary-100 text-center">
                        <h4 className="text-primary-900 font-bold mb-2">Binanızın Durumunu Öğrenin</h4>
                        <p className="text-sm text-gray-600 mb-4">Ücretsiz ön analiz raporu için hemen başvurun.</p>
                        <Link to="/on-analiz" className="inline-block bg-accent hover:bg-accent-600 text-white font-medium px-6 py-2 rounded-lg transition-colors">
                            Analiz Başlat
                        </Link>
                    </div>
                </div>
